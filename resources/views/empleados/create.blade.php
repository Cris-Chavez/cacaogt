                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" placeholder="Ingrese los nombres del empleado" id="nombre" name="nombre" value="{{ old('nombre') }}">
                      @error('nombre')
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" placeholder="Ingrese los apellidos del empleado" id="apellido" value="{{ old('lastName') }}" name="apellido">
                      @error('apellido')
                        <strong class="text-red">{{ $message }}</strong>                          
                      @enderror
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" placeholder="Ingrese el teléfono del empleado" id="telefono" name="telefono" value="{{ old('telefono') }}">
                      @error('telefono')
                        <strong class="text-red">{{ $message }}</strong>                          
                      @enderror
                    </div>
